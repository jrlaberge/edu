...
PROJECT_NAME="find-seller-app-dev-252702"
...
PUBLIC_ASSETS="fsdev-jl-public-bucket"

# This is the Storage bucket used for private assets. 
# The entire bucket is private by default
PRIVATE_ASSETS="fsdev-jl-private-bucket"

# The name of the Pubsub topic to create / use
PUB_SUB_TOPIC="fsdev-jl-items"

# The name of the custom network for the product and ads services
SERVICES_NETWORK="fsdev-jl-app-network"

# The name of the product service subnet
PRODUCT_SUBNET="fsdev-jl-prod-app-network-subnet"

# The name of the product service subnet
ADS_SUBNET="fsdev-jl-ad-app-network-subnet"

# The name of the Kubernetes cluster used for the products service
PRODUCT_CLUSTER_NAME="fsdev-jl-app-clusters"

# The name of the spanner instance
PRODUCT_DB_INSTANCE_NAME="fsdev-jl-app-spanner-instance"

# The name of the spanner db
PRODUCT_DB_NAME="fsdev-jl-app-spanner-db"
